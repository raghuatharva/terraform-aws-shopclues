...
```
mysql -h shopclues-dev.czn6yzxlcsiv.us-east-1.rds.amazonaws.com -u root -pshopclues1
```
* Clone shipping component into bastion
```
git clone https://github.com/terraform-aws-shopclues/shipping.git
```
* Load the data into mysql
```
mysql -h shopclues-dev.czn6yzxlcsiv.us-east-1.rds.amazonaws.com -u root -pshopclues1 < shipping/db/schema.sql
```
```
mysql -h shopclues-dev.czn6yzxlcsiv.us-east-1.rds.amazonaws.com -u root -pshopclues1 < shipping/db/app-user.sql
```
```
mysql -h shopclues-dev.czn6yzxlcsiv.us-east-1.rds.amazonaws.com -u root -pshopclues1 < shipping/db/master-data.sql
```
...
```
aws eks update-kubeconfig --region us-east-1 --name shopclues-dev
```
...
* Create namespace shopclues
```
kubectl create namespace shopclues
```
